...
act_cmd_status_strings = {
    pylon.GigEActionCommandStatus_Ok: "The device acknowledged the command",
    pylon.GigEActionCommandStatus_NoRefTime: "The device is not synchronized to a master clock",
    pylon.GigEActionCommandStatus_Overflow: "The action commands queue is full",
    pylon.GigEActionCommandStatus_ActionLate: "The requested action time was at a point in time that is in the past",
}
